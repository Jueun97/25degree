...
const Details = ({data,updatePost,comments,deletePost,uploadComment,likes,popLikes,pushLikes}) => {
    ...
    return (
        <div className={styles.details}>
            ...
            <Info data={data}post={post} updatePost={updatePost} deletePost={deletePost} filteredComments={filteredComments} uploadComment={uploadComment} filteredLikes={filteredLikes} popLikes={popLikes} pushLikes={pushLikes}></Info>
        </div>
    );
};
