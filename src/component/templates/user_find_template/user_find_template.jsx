...
const UserFindTemplate = ({findHandler,onClickFindAction}) => {
    return (
        <div className={styles.container}>
            <Heading1 className="user_logo" text="25도씨"/>
            <Buttons className="user_find" text1="아이디 찾기" text2="비밀번호 찾기" onClick1={onClickFindAction} onClick2={onClickFindAction} />
